...
import static com.base.util.Const.*;
...
public class TestDeck {
    ...
    public void testCreatingDeckWithFileChosen() throws IOException {
        Deck fileInputDeck = new Deck(TEST_FILE_NAME, FILE);
    ...
    public void testReadingCardsFromFile() throws IOException {
        File inputFile = new File(Objects.requireNonNull(getClass().getClassLoader().getResource(TEST_FILE_NAME)).getFile());
    ...
    public void testRetrieveCardFromTopOfDeck() throws IOException {
        Deck fileInputDeck = new Deck("cardFile_test.txt", FILE);
